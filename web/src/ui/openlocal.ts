...
export function installOpenLocal(open: (input: any) => Promise<void>): void {
  ...
  ov.innerHTML =
    ...
    '<div class="dropsub">a <code>.h5ad</code>, a 10x <code>.h5</code>, or a <code>.lstar.zarr.zip</code> file, or a <code>.lstar.zarr</code> folder — nothing is uploaded</div></div>';
