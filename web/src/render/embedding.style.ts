...
export interface EmbeddingStyle {
  ...
  hint: { grow: number; opacity: number; ring: number; mode: "ring" | "lift" | "fill" };
...
export function defaultEmbeddingStyle(dark: boolean): EmbeddingStyle {
  return {
    ...
    hint: { grow: 0.7, opacity: 215, ring: 1.4, mode: "lift" },
...
export const EMBEDDING_RANGES: Record<string, [number, number]> = {
  ...
  "selection.fillGrow": [0, 24], "selection.fillOpacity": [0, 255], "hint.grow": [0, 24], "hint.opacity": [0, 255], "hint.ring": [0, 6],
